...
import { Car, Loader2, ArrowLeft, Building, Plane, MapPin } from 'lucide-react';
...
const ParkingSlot = ({ slot, onSelect, isSelected }) => {
    ...
    const baseClasses = "relative aspect-square rounded-lg flex flex-col items-center justify-center font-bold text-sm border-2 transition-all duration-200";
    ...
    const statusClasses = {
        ...
        booked: "bg-gray-300 dark:bg-gray-700 border-gray-400 dark:border-gray-600 text-gray-500 dark:text-gray-400 cursor-not-allowed",
...
export default function LocationDetailPage() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            setLoading(true);
            try {
                // Fetch location details and slots in parallel
    ...
    const handleSelectSlot = (slot) => {
        // Jika slot yang sama diklik lagi, batalkan pilihan. Jika beda, ganti pilihan.
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                <div className="flex justify-between items-center mb-6 border-b dark:border-gray-700 pb-4">
                    ...
                    <div className="flex items-center gap-4 text-sm">
                        ...
                        <span className="flex items-center gap-2"><div className="w-4 h-4 rounded bg-gray-300 border border-gray-400"></div> Terisi</span>
                    </div>
                </div>
